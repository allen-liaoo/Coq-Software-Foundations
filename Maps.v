...
Proof.
  ...
  - unfold not in H. destruct H. apply e.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  unfold t_update. destruct (eqb_spec x x0); reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  destruct (eqb_spec x x0); try rewrite e; reflexivity.
Qed.
(** [] *)
...
Proof.
  intros. apply functional_extensionality. intros.
  unfold t_update. destruct (eqb_spec x1 x); destruct (eqb_spec x2 x).
