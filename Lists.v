...
Proof. intros. destruct x. simpl. rewrite eqb_refl. reflexivity. Qed.
(** [] *)
...
Proof.
    intros.
    assert (U: update d x v = record x v d).
    { reflexivity. }
    rewrite U. simpl. rewrite eqb_id_refl. reflexivity.
Qed.
(** [] *)
...
Proof.
    intros d x y o.  
    intro H.
    assert (U: update d y o = record y o d).
    { reflexivity. }
    rewrite U. simpl. rewrite H. reflexivity.
Qed.
(** [] *)
End PartialMap.
