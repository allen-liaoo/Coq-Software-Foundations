...
Theorem grade_comparison_unfold : 
    forall (g1 g2 : grade), (*(l1 l2 : letter) (m1 m2 : modifier),*)
    grade_comparison g1 g2 =
    match (g1, g2) with
    | (Grade l1 m1, Grade l2 m2) => 
        match letter_comparison l1 l2 with
        | Eq => modifier_comparison m1 m2
...
Proof.
    ...
    destruct m.
    - simpl.
      rewrite grade_comparison_unfold. 
    ...
    - simpl.
      ...
      reflexivity.
    - simpl. destruct l.
      + simpl. rewrite grade_comparison_unfold. simpl. reflexivity.
      + simpl. rewrite grade_comparison_unfold. simpl. reflexivity.
      + simpl. rewrite grade_comparison_unfold. simpl. reflexivity.
      + simpl. rewrite grade_comparison_unfold. simpl. reflexivity.
      + rewrite H. reflexivity.
