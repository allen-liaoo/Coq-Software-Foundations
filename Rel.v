...
Proof.
  ...
  intros.
  assert (1=2) as N. 
  { apply (H 0 1 2 (total_rel 0 1) (total_rel 0 2)). }
  discriminate N.
Qed.
(** [] *)
...
Proof.
  ...
  { exists 0. apply le_S. apply le_n. }
  destruct H0 as [n H0].
  apply H in H0. apply le_Sn_n in H0. apply H0.
Qed.
(** [] *)
...
Theorem le_antisymmetric :
  antisymmetric le.
Proof.
  unfold antisymmetric. intros a b H H1.
  induction H1.
  - reflexivity.
  - pose proof (le_trans _ _ _ H H1).
    apply le_Sn_n in H0. destruct H0.
Qed.
(** [] *)
...
Proof.
  intros. split.
  - intro H. induction H as [| | x y z Hxy IH Hyz IH2].
    + apply rt1n_trans with y. apply H. apply rt1n_refl.
    + apply rt1n_refl.
    + apply (rsc_trans _ _ _ _ _ IH IH2).
  - intro H. induction H as [| x y z Hxy Hr IH].
    + apply rt_refl.
